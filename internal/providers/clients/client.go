...
// AvailableProviders contains all available provider names and their
// corresponding clients. Add implemented providers here.
...
type Client interface {
	...
	// AwaitProvisioning blocks the thread until the server is ready to receive
	// SSH connections.
	...
	// Connect is a helper method that provisions and connects to a provider's
	// client, if required
